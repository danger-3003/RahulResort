...
function Home() {
    return (
        <div className="py-20 pt-32 md:py-40 md:pt-52 font-poppins h-max w-full flex items-center justify-center" style={{background:`linear-gradient(to bottom,rgba(0,0,0,0.6),rgba(0,0,0,0.2)),url(${Bg})`,backgroundPosition:"center",backgroundSize:"cover"}}>
