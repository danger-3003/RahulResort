        ...
        <div ref={galleryRef} className='flex items-center justify-center flex-col pt-20'>
            <div className='w-full lg:w-[50rem] xl:w-[60rem] flex items-center justify-center flex-col pb-10'>
                ...
                <div className='w-screen xl:w-full flex items-center justify-center flex-wrap my-5 gap-[2%] lg:gap-[1rem]'>
                    <div className='w-[47%] lg:w-[27.5rem]'>
                        <img src={Drone1} alt="Drone Shot 1" className='md:rounded-2xl shadow-lg shadow-black/20' />
                    </div>
                    <div className='w-[47%] lg:w-[27.5rem]'>
                        <img src={Drone2} alt="Drone Shot 2" className='md:rounded-2xl shadow-lg shadow-black/20' />
                    </div>
                </div>
            ...
            <div className='bg-bg w-full py-10 flex items-center justify-center'>
                <div className='flex items-center justify-center flex-wrap px-5 w-full gap-10 h-max lg:w-[50rem] py-10'>
                    <div className='hidden md:block'>
                        <img src={DroneNight} alt="Rahul Resort Night View" className='w-[23rem] h-[35rem] lg:w-[25rem] lg:h-[33rem] object-center object-cover shadow-xl shadow-black/10' />
                    </div>
                    <div className='w-[25rem] md:w-[18rem] lg:w-[20rem]'>
                        <img src={GroupPic} alt="Rahul Resort Customers" className='w-full object-cover shadow-xl shadow-black/10' />
                        <div className='mt-10'>
